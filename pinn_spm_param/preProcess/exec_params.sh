...
cd $dataFolder
python main.py -nosimp -opt -p 0.5 1
#python main.py -nosimp -opt -p 0.5 10
#python main.py -nosimp -opt -p 4 1
#python main.py -nosimp -opt -p 4 10
#python main.py -nosimp -opt -p 2 2
cd ../preProcess
echo Done!
